...
namespace DatabaseFirstEFCore.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,StudentName,Gender,Age")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StudentName,Gender,Age")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
